 ...
 *
 * Disassembly of DSDT.aml, Fri Jul 24 11:00:04 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00013FD4 (81876)
 *     Revision         0x02
 *     Checksum         0xB7
 *     OEM ID           "Apple "
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "Apple ", "Notebook", 0x00000012)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCAB00C18, 0x02B2)
            ...
            Method (WMNB, 3, NotSerialized)
            {
                ...
                If (LEqual (Local0, 0x53545344))
                {
                    ...
                    If (LEqual (IIA0, 0x00120041))
                    {
                        ...
                        Else
                        {
                            Subtract (0x00010000, 0x15, Local2)
    ...
    Scope (_SB.PCI0)
    {
        Device (BAT0)
        {
            ...
            Method (_BIX, 0, NotSerialized)  // _BIX: Battery Information Extended
            {
                ...
                Store (B1B2(^^LPCB.EC0.XC31,^^LPCB.EC0.XC32), Index (BIXT, 0x08))
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Method (BIFA, 0, NotSerialized)
        {
            If (ECAV ())
            {
                If (BSLF)
                {
                    Store (B1B2(^^EC0.B1S1,^^EC0.B1S2), Local0)
                }
                Else
                {
                    Store (B1B2(^^EC0.B0S1,^^EC0.B0S2), Local0)
                }
            }
            Else
            {
        ...
        Method (TACH, 1, Serialized)
        {
            ...
            If (ECAV ())
            {
                While (One)
                {
                    ...
                    If (LEqual (_T_0, Zero))
                    {
                        Store (B1B2(^^EC0.TBH1,^^EC0.TBH2), Local0)
                        Break
                    }
                    Else
                    {
                        If (LEqual (_T_0, One))
                        {
                            Store (B1B2(^^EC0.TCH1,^^EC0.TCH2), Local0)
                            Break
                        }
                        Else
                        {
    ...
    Scope (\)
    {
        ...
        {
            /* 0000 */  0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0x00, 0x00,
